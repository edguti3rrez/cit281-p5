...
module.exports = class MonsterGame {
  ...
  listMonsters = () => {
    this.monsters.forEach( monsterObj => {
        ...
        // Displays monster stats after each life drainage
        let monsterStatus = monsterObj.isAlive ? 'Alive' : 'Dead';
        console.log(`Monster: ${monsterObj.monsterName}, Minimim Life: ${monsterObj.minimumLife}, Current Life: ${monsterObj.currentLife}, Status: ${monsterStatus}`);
    });
  }
